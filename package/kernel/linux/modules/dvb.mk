...
define KernelPackage/dvb-usb-cxusb
  TITLE:=Mygica T230 DVB-T/T2/C devices
  ...
  DEPENDS:= \
	+PACKAGE_kmod-dvb-tuner-dib0070:kmod-dvb-tuner-dib0070 \
    +PACKAGE_kmod-media-tuner-si2157:kmod-media-tuner-si2157
  $(call AddDepends/dvb-usb,+kmod-media-tuner-si2157 +kmod-dvb-tuner-dib0070 +kmod-dvb-si2168)
endef

define KernelPackage/dvb-usb-cxusb/description
 the Conexant USB2.0 hybrid reference design.
...
define KernelPackage/dvb-usb-dw2102
  ...
  $(call AddDepends/dvb-usb,+kmod-dvb-ds3000)
endef
...
define KernelPackage/dvb-usb-tbs5520se
  TITLE:=Turbosight TBS5520SE USB2 DVB-T/T2/C/C2/S/S2/ISDB-T device
  KCONFIG:=CONFIG_DVB_USB_TBS5520SE
  FILES:=$(LINUX_DIR)/drivers/media/usb/dvb-usb/dvb-usb-tbs5520se.ko
  AUTOLOAD:=$(call AutoProbe,dvb-usb-tbs5520se)
  DEPENDS:= \
  +PACKAGE_kmod-media-tuner-si2157:kmod-media-tuner-si2157 \
  +PACKAGE_kmod-media-tuner-av201x:kmod-media-tuner-av201x   
  $(call AddDepends/dvb-usb,+kmod-media-tuner-av201x +kmod-media-tuner-si2157 +kmod-dvb-si2183)
endef
...
define KernelPackage/dvb-usb-v2
  ...
  DEPENDS:=+PACKAGE_kmod-rc-core:kmod-rc-core +PACKAGE_kmod-i2c-core:kmod-i2c-core
...
define KernelPackage/dvb-si2183/description
 Silicon Labs Si2183
endef
...
define KernelPackage/media-tuner-av201x/description
 Airoha Technology AV201x silicon tuner.
endef
